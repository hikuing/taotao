...
<table class="easyui-datagrid" id="itemList" title="商品列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'cid',width:100,formatter:TAOTAO.formatCid">叶子类目</th>
    ...
    var toolbar = [{
        			...
        			//加载商品类目
         			function getCname() {
	       				 $.ajax({
	           				...
	           				statusCode:{
	           					200:function(_data) {
	           						$("#cname").html(_data.name);
	           					}
	           				}
	           			});
       					return "<span id='cname'></span>";
        			} 
        ...
        handler:function(){
        	...
        	$.messager.confirm('确认','确定下架ID为 '+ids+' 的商品吗？',function(r){
        	    if (r){
        	    	var params = {"ids":ids,"_method":"PUT","status":"instock"};
            		$.ajax({
            			type:"POST",
            			url:"/rest/item",
            			data:params,
        ...
        handler:function(){
        	...
        	$.messager.confirm('确认','确定上架ID为 '+ids+' 的商品吗？',function(r){
        	    if (r){
        	    	var params = {"ids":ids,"_method":"PUT","status":"reshelf"};
                	$.ajax({
            			type:"POST",
            			url:"/rest/item",
            			data:params,
